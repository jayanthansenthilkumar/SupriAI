...
export default function NodeApi() {
  ...
  const checkHealth = async () => {
    ...
    try {
      ...
      setHealth(null);
      setError(e.message || 'Failed to reach Node API');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="page-content">
      <div className="page-header">
        <h2><Server size={24} /> Node API Health</h2>
      ...
      <motion.div className="card" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <p className="text-secondary mb-4">Endpoint: <code>http://localhost:3001/api/health</code></p>
